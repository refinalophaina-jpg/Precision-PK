# VANCOMYCIN TDM SOFTWARE — CHUNK 3 BRAIN DOCUMENT
...
vancomycin Therapeutic Drug Monitoring (TDM) application called VancoPK.
...
```
[VANCOPK AUC TDM]  [Patient][Dosing][Results][History][Alternatives][Export]
─────────────────────────────────────────────────────────────────────────────
...
Message: "Vancomycin is NOT indicated for this organism.
          VancoPK is designed for MRSA and susceptible gram-positive TDM only.
...
OPTION A — Full single-file build:
  ...
  Request: "Build complete VancoPK single JSX file"
...
```
[SYSTEM]:
You are building VancoPK, a clinical vancomycin TDM decision support application.
...
Disclaimer:
  [ ] Footer: "VancoPK | Based on 2020 ASHP/IDSA/PIDS/SIDP Vancomycin Guidelines"
...
---
*Brain Document v3.0 | March 2026*
*Chunks 1-3 form the complete specification for VancoPK Opus build.*
